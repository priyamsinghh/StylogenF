    ...
    const handleResetContext = () => {
        axios
            .post("http://localhost:8000/api/deletecontext/",
                { text: inputData }, // Consider if this is correct
                {
                    headers: {
                        'Authorization': Cookies.get('jwt'),
                    }
            ...
            .then(res => {
                console.log(res);
                setInputData(''); // Clear input data after resetting context
            })
            .catch(res => console.log(res));
    }
        ...
        <div className="home">
                    ...
                    return <div className="wrapping-item">
                        <div className="item">
                            ...
                            <div className="image-wrap">
                                ...
                                <img src={data.blob_url} loading="eager" alt="result" />
                            </div>
                        </div>
                    </div>
                })}
            ...
            <div className="bottom-chat-box">
                <input
                    ...
                    placeholder="Type here to Prompt StyloGen..."
                />
