from sklearn.feature_extraction.text import CountVectorizer  #transforms the text data into a sparse matrix where each element represents the frequency of a word in a document
from sklearn.metrics.pairwise import cosine_similarity       #determine the similarity of text documents 
import numpy as np
